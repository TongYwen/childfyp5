...
def admin_delete_user(user_id):
    ...
    # Check if the user being deleted is a parent
    cursor.execute(
    ...
    # Prevent deletion of parent accounts
    if normalize_role(user_role) == "parent":
        cursor.close()
        conn.close()
        flash(
            "Parent accounts cannot be deleted. Only admin accounts can be removed from the system.",
            "danger",
        )
        return redirect(url_for("admin_users"))
